...
@section('main-content')
    ...
    <div class="main-info mb-4">
        <h4 class="product-title mb-3">{{$product_detail->title}}</h4>
    ...
    <div class="product-options">
        <form action="{{route('single-add-to-cart')}}" method="POST">
            ...
            <!-- Size Guide -->
            <div class="size-guide-wrapper mb-4">
                <div class="size-guide-header d-flex justify-content-between align-items-center mb-3">
                    <h5 class="mb-0">Size Guide</h5>
                    <div class="size-guide-tabs">
                        <button type="button" class="btn btn-sm btn-link active" data-toggle="tab" data-target="#tops">Tops</button>
                        <button type="button" class="btn btn-sm btn-link" data-toggle="tab" data-target="#pants">Pants</button>
                    </div>
                </div>
                <div class="tab-content size-guide-content">
                    <!-- Existing size guide tables here -->
                </div>
            </div>
            @endif
            ...
            <div class="product-actions">
                ...
                <a href="{{route('add-to-wishlist',$product_detail->slug)}}" class="btn btn-outline-secondary btn-lg">
                    <i class="ti-heart"></i>
                </a>
            </div>
        </form>
...
.size-guide-tabs .btn-link {
    color: #666;
    text-decoration: none;
    padding: 8px 16px;
}

.size-guide-tabs .btn-link.active {
    color: #F7941D;
    font-weight: 500;
}
